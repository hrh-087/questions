...
MIDDLEWARE = [
    ...
    'question_repo.middleware.simple_middleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 如果使用render响应请求，会调用context_proccessors中的处理器
...
CACHES = {
    'default': {
        ...
        # 'LOCATION': 'redis://192.168.0.15:6379',
        "OPTIONS": {
